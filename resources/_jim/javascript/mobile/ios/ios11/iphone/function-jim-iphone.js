		...
		jQuery("#jim-iphone-dd").on("mouseup", function(event, data) {
			...
			if(dragStart) {
				...
				if(jQuery("#jim-case").hasClass("portrait") && parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top'))*zoom>88) 
					topPos = 88;
				else if(jQuery("#jim-case").hasClass("landscape") && parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top'))*zoom>66)
					topPos = 66;
				else {
			...
			if(dragStart) {
				...
				if(posY<offset.top) {
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						jQuery("#jim-iphone-dd_options .dd_options").animate({ "top" : 66 + "px", queue:false });
						jQuery("#jim-iphone-dd_options_big .dd_options").animate({ "top" : 0 + "px", queue:false });
					}
					dragStart=false;
				}
					...
					if(jQuery("#jim-case").hasClass("portrait")) {
						...
						if(jQuery("#jim-iphone-dd_options").attr('id') === jQuery(event.target).parent().attr('id'))
							jQuery("#jim-iphone-dd_options_big .dd_options").css("top", parseInt(jQuery("#jim-iphone-dd_options .dd_options").css('top'))-66 +"px");
						else jQuery("#jim-iphone-dd_options .dd_options").css("top", parseInt(jQuery("#jim-iphone-dd_options_big .dd_options").css('top'))+66 +"px");
					}
				}
			}
		...
		switch(type) {
			...
			case itemType.nativedropdown:
				...
				if(jQuery("#jim-case").hasClass("portrait")) {
					...
					jQuery("#jim-iphone-dd_options .dd_options").animate({ "top" : -(selectedPos*childHeight) + 66 + "px", queue:false });
